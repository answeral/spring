					...
					<div class="orderDivMt">
						<table summary="NO, 제목, 등록일, 조회수 순으로 공지사항을 조회 하실수 있습니다." class="orderTable2" border="1" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									<td class="tnone">${nddto.bno }</td>
									<td class="left">
										<a href="/customer/notice_view">${nddto.btitle }</a>
										<img src="../images/ico/ico_new.gif" alt="NEW" />
									</td>
									<td>${nddto.id }</td>
									<td>
									<fmt:formatDate value="${nddto.bdate }" pattern="yyy-MM-dd"/>
									</td>
									<td class="tnone right">${nddto.bhit }</td>
								</tr>
								</c:forEach>
