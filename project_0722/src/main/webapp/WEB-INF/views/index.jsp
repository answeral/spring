...
<section class="banner-sec">
    ...
    <div class="row">
        ...
        <div class="card"> <img class="img-fluid" src="img/media-3.jpg" alt="">
                <div class="card-img-overlay"> <span class="tag tag-pill tag-info">Politics</span> </div>
                <div class="card-block">
            <div class="news-title">
        ...
        <div class="card"> <img class="img-fluid" src="img/media-2.jpg" alt="">
                <div class="card-img-overlay"> <span class="tag tag-pill tag-success">Travel</span> </div>
                <div class="card-block">
            <div class="news-title">
        ...
        <div class="card"> <img class="img-fluid" src="img/media-4.jpg" alt="">
                <div class="card-img-overlay"> <span class="tag tag-pill tag-danger">News</span> </div>
                <div class="card-block">
            <div class="news-title">
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"> 
            ...
            <div class="carousel-item active">
                ...
                <div class="news-media"><img class="img-fluid" src="img/media-5.jpg" alt=""></div>
                <div class="news-title">
            ...
            <div class="carousel-item">
                    <div class="news-block">
                <div class="news-media"><img class="img-fluid" src="img/media-6.jpg" alt=""></div>
                <div class="news-title">
            ...
            <div class="carousel-item">
                    <div class="news-block">
                <div class="news-media"><img class="img-fluid" src="img/media-7.jpg" alt=""></div>
                <div class="news-title">
...
<section class="section-01">
    ...
    <div class="row">
        ...
        <div class="row">
                <div class="col-lg-6">
            <div class="card"> <img class="img-fluid" src="img/media-9.jpg" alt="">
                    <div class="card-block">
                ...
                <div class="col-lg-6">
            <div class="card"> <img class="img-fluid" src="img/media-10.jpg" alt="">
                    <div class="card-block">
                <div class="news-title"><a href="#">
                  <h2 class=" title-small">Minorities Suffer From Unequal Pain Treatment</h2>
                  </a></div>
                ...
                <div class="col-lg-6">
            <div class="card"> <img class="img-fluid" src="img/media-7.jpg" alt="">
                    <div class="card-block">
                <div class="news-title"><a href="#">
                  <h2 class=" title-small">Minorities Suffer From Unequal Pain Treatment</h2>
                  </a></div>
                ...
                <div class="col-lg-6">
            <div class="card"> <img class="img-fluid" src="img/media-8.jpg" alt="">
                    <div class="card-block">
                <div class="news-title"><a href="#">
                  <h2 class=" title-small">Minorities Suffer From Unequal Pain Treatment</h2>
                  </a></div>
        ...
        <div class="tab-content sidebar-tabing">
            ...
            <div class="media"> <a class="media-left" href="#"> <img class="media-object" src="img/media-1.jpg" alt=""> </a>
            ...
            <div class="media"> <a class="media-left" href="#"> <img class="media-object" src="img/media-2.jpg" alt=""> </a>
                    <div class="media-body">
                <div class="news-title">
                        <h2 class="title-small"><a href="#">Obamacare Appears to Be Making People Healthier</a></h2>
                      </div>
            ...
            <div class="media"> <a class="media-left" href="#"> <img class="media-object" src="img/media-3.jpg" alt=""> </a>
                    <div class="media-body">
                <div class="news-title">
                        <h2 class="title-small"><a href="#">Key Republicans sign letter warning against candidate</a></h2>
                      </div>
            ...
            <div class="media"> <a class="media-left" href="#"> <img class="media-object" src="img/media-4.jpg" alt=""> </a>
                    <div class="media-body">
                <div class="news-title">
                        <h2 class="title-small"><a href="#">Key Republicans sign letter warning against candidate</a></h2>
                      </div>
...
<section class="video-gallery-sec">
    ...
    <div class="row">
        ...
        <div class="news-block">
            ...
            <div class="col-md-3">
        <div class="news-block">
                <div class="news-media"><a class="example-image-link" href="img/media-3.jpg" data-lightbox="media-3" data-title="Delta passengers got pizza delivered to the plane"><img class="img-fluid" src="img/media-3.jpg" alt=""></a><span class="gallery-counter"><i class="fa fa-image"></i>17</span></div>
                <h2 class=" title-small">Delta passengers got pizza delivered to the plane</h2>
                <div> </div>
              </div>
      </div>
            <div class="col-md-3">
        <div class="news-block">
                <div class="news-media"><a class="example-image-link" href="img/media-4.jpg" data-lightbox="media-4" data-title="He took Bolt's record - can he?"><img class="img-fluid" src="img/media-4.jpg" alt=""></a><span class="gallery-counter"><i class="fa fa-image"></i>06</span></div>
            ...
            <div class="col-md-3">
        <div class="news-block">
                <div class="news-media"><a class="example-image-link" href="img/media-5.jpg" data-lightbox="media-5" data-title="Minorities Suffer From Unequal Pain Treatment"><img class="img-fluid" src="img/media-5.jpg" alt=""></a><span class="gallery-counter"><i class="fa fa-image"></i>09</span></div>
                <h2 class=" title-small">Minorities Suffer From Unequal Pain Treatment</h2>
                <div> </div>
              </div>
      </div>
    ...
    <div class="row">
        ...
        <div class="news-block">
            ...
            <div class="col-md-3">
        <div class="news-block">
                <div class="news-media"><a class="example-image-link" href="img/media-7.jpg" data-lightbox="media-7" data-title="Delta passengers got pizza delivered to the plane"><img class="img-fluid" src="img/media-7.jpg" alt=""></a><span class="gallery-counter"><i class="fa fa-image"></i>11</span></div>
                <h2 class=" title-small">Delta passengers got pizza delivered to the plane</h2>
                <div> </div>
              </div>
      </div>
            <div class="col-md-3">
        <div class="news-block">
                <div class="news-media"><a class="example-image-link" href="img/media-8.jpg" data-lightbox="media-8" data-title="He took Bolt's record - can he?"><img class="img-fluid" src="img/media-8.jpg" alt=""></a><span class="gallery-counter"><i class="fa fa-image"></i>05</span></div>
                <h2 class=" title-small">He took Bolt's record - can he?</h2>
                <div> </div>
              </div>
      </div>
            <div class="col-md-3">
        <div class="news-block">
                <div class="news-media"><a class="example-image-link" href="img/media-9.jpg" data-lightbox="media-9" data-title="Best moments in travel"><img class="img-fluid" src="img/media-9.jpg" alt=""></a><span class="gallery-counter"><i class="fa fa-image"></i>15</span></div>
