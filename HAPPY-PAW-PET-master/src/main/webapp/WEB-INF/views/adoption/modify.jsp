...
<body>
	...
	<section>
	    ...
	    <form action="/adoption/doUpdate" name="modify" method="post" enctype="multipart/form-data">
	      ...
	      <input type="hidden" name="bfile" value="${adoptDto.bfile}">
	        <colgroup>
	          <col width="15%">
	          <col width="85%">
	        </colgroup>
	        <tr>
	          <th>작성자</th>
	          <td>
	            <input type="text" name="id" value="${adoptDto.id}" readonly="readonly">
	          </td>
	        </tr>
	        <tr>
	          <th>제목</th>
	          <td>
	            <input type="text" name="btitle" value="${adoptDto.btitle }">
	          </td>
	        </tr>
	        <tr>
	          <th>내용</th>
	          <td>
	            <textarea name="bcontent" cols="50" rows="10">${adoptDto.bcontent}</textarea>
	          </td>
	        </tr>
	        <tr>
	          <th>이미지 표시</th>
	        ...
	        <tr>
	          <th>파일이름</th>
	          <c:if test="${adoptDto.bfile != null}">
	          	<td style="text-align: left">${adoptDto.bfile}</td>
	          </c:if>
	          <c:if test="${adoptDto.bfile == null}">
	          	<td>첨부파일 없음</td>
	          </c:if>
