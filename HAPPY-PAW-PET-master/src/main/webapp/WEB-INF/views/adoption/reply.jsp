...
<body>
    ...
    <form action="/adoption/doReply" name="reply" method="post" enctype="multipart/form-data">
      <input type="hidden" name="bno" value="${adoptDto.bno }">
      <input type="hidden" name="bgroup" value="${adoptDto.bgroup }">
      <input type="hidden" name="bstep" value="${adoptDto.bstep }">
      <input type="hidden" name="bindent" value="${adoptDto.bindent }">
      <table>
        <colgroup>
          <col width="15%">
          <col width="85%">
        ...
        <tr>
          <th>제목</th>
          <td>
            <input type="text" name="btitle" value="[답변] ${adoptDto.btitle }">
          </td>
        </tr>
        <tr>
          <th>내용</th>
