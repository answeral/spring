...
public class EmailServiceImpl implements EmailService {
	...
	public void email_send(String name, String email) {
		...
		message.setTo(email);
		message.setFrom("andante6335@gmail.com");
		message.setSubject(name+"님의 비밀번호 초기화가 되었습니다.\n");
		message.setText("[ 임시 비밀번호 :"+pwCode+"]\n");
	...
	public void email_send2(String name, String email) {
		...
		try {
			...
			String htmlData = "<tr>	\r\n"
					...
					+ "<img src='http://localhost:8181/images/img_txt_password02.jpg' alt='JARDIN에서 비밀번호 찾기를 요청하셨습니다.' /></p> "
			...
			//보내는 이메일 주소
			message.setFrom(new InternetAddress("andante6335@gmail.com"));
			// 받는 이메일 주소
